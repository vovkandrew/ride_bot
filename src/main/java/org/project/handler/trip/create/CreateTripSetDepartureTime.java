...
@Component
public class CreateTripSetDepartureTime extends UpdateHandler {
    private final TripService tripService;

    public CreateTripSetDepartureTime(TripService tripService) {
    ...
    public void initHandler() {
        handlerPhase = getPhaseService().getPhaseByHandlerName(CREATE_TRIP_PROVIDE_DEPARTURE_TIME);
    }
}

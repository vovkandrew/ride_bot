...
public class CreateRouteSetCountryTo extends UpdateHandler {
    ...
    public boolean isApplicable(Optional<Phase> phaseOptional, Update update) {
        return super.isApplicable(phaseOptional, update) || isUpdateContainsHandler(update, SET_ROUTE_COUNTRY_TO);
    }
    ...
    public void handle(UserPhase userPhase, Update update) throws TelegramApiException {
        ...
        sendRemovableMessage(userId, PROVIDE_CITY_TO, getAvailableCitiesKeyboard(
                cityService.findAllUnusedCitiesTo(route, pageRequest), SET_ROUTE_CITY_TO_NEXT, SET_ROUTE_CITY_TO));
    }

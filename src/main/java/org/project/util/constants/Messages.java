...
public class Messages {
    ...
    public static final String CHECK_AVAILABLE_SEATS = "Перевірка наявності вільних пасажирських місць";
    ...
    public static final String CONTINUE_NEW_BOOKING = "Завершіть бронювання попередрьої поїздки!";
}

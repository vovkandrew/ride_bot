...
public class Messages {
    ...
    public static final String MOVE_TO_PREVIOUS_SELECTION_CITIES = "Повернутись до вибору міст";
    public static final String MOVE_TO_PREVIOUS_SELECTION_COUNTRIES= "Повернутись до вибору країн";
}
